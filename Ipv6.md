...
[آموزش های سوم متنی(اگه با لینوکس آشنایی دارین)
](https://linux.die.net/HOWTO/Linux+IPv6-HOWTO/configuring-ipv6to4-tunnels.html)


این سه تا اموزش بالا رو ببینید به راحتی میتونید کانفیگ کنید ولی اگه موفق نشدین باید ودیو با جزییات رو ببینید ؛
