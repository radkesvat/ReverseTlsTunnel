...
* * *
اگه بعضی وقتا که میخواین یه صفحه وب جدید باز کنین یا همون قبلیا رو رفرش کنید  ؛ طول میکشه ؛ بهتره که این سوییچ رو اضافه کنید به دستور سرور خارج
> --pool:4

این سوییچ دیفالتش ۱۶ هست که میتونید به دلخواه کم و زیادش کنید ؛ اگه از یه سرور افراد کمی استفاده میکنن مثلا ۱۰ نفر بهتره که بزاریدش روی ۴

این عدد تعداد کانکشن هایی هست که سرور خارج قبل از اینکه حتی کاربری کانکنت بشه ؛ به سرور ایران میزنه میزاره تو آبنمک ؛ اگه مدت طولانی تو آب نمک بمونه فایروال یکم گیج میزنه یادش میره کانکشن رو واسه 
همین لگ ایجاد میشه و بهتره کسایی که کاربر زیاد ندارن این مقدارو کمتر کنن
