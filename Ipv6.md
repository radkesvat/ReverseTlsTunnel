...
خلاصه بگم ؛ گیت هاب ایپی وی 6 ساپورت نکرده و ۲ تا راه داریم
...
معقول ترین راه استفاده از ایپی وی 6 این روشه ؛ که از ایپی وی 6 برای تونل استفاده میکنه و هیچ محدودیتی هم برای کار بر یا شما ایجاد نمیکنه چون برای خارج هم قراره ایپی وی ۴ تهیه کنیم؛ شروع کنیم
...
ایپی وی 6 میبینه از سرور خارج شما


در سرور ایران که هم ایپی وی 6 داریم هم وی ۴ ؛ تونل رو عادی اجرا میکنیم
...
و هم سایت هایی که ایپی وی ۶ ساپورت میکنن هم باز کنه و استفاده کنه ؛ البته اگه خواستید از ایپی وی 6 برای بازدید از سایتی استفاده نکنه اینو توی پنل اتون میتونین تنظیم کنین 
...
خوب الان ایپی وی 6 خارج رو داریم ؛ حالا باید یه سرور ایران بخریم که ایپی وی 6 داشته باشه ؛ از کجا ؟ خوب خیلی جا ها مثل هاست ایران ؛ صفر و یک و کلا سرچ کنید خیلی هستن
