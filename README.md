...
[راهنمای آپلود فیک](https://github.com/radkesvat/ReverseTlsTunnel/blob/master/FUpload.md)
 ...
 قابلیت آیپی وی سیکس تانل اوکی شده و تست شده ؛ باید فقط داکیومنت کنم که فردا میگم چطور استفاده کنید
...
این سوییچ دیفالتش 24 هست که میتونید به دلخواه کم و زیادش کنید 
این عدد تعداد کانکشن هایی هست که سرور خارج قبل از اینکه حتی کاربری کانکنت بشه ؛ به سرور ایران میزنه و میزاره تو آب نمک ؛‌ دقت کنید اگه مشکل خاصی ندارید تغییری ندین این سوییچ را ؛ بیشتر برای کسایی که لودبالانس میکنند 
شاید بخوان این مقدارو روی ۱۲ تنظیم کنن اگه ۲ تا یا بیشتر سرور خارج دارن
